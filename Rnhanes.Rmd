...
We now demonstrate the use of the `nhanesA` R package **_through some examples. The first example uses tools in_** the `survey` package to look at average blood pressure for individuals over 40 years of age by reported ethnicity for the 2017-2018 cycle. For that we download and merge the demographic data (`DEMO_J`) and the blood pressure data (`BPX_J`). 
